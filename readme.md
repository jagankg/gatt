...
## Usage
Please see [godoc.org](http://godoc.org/github.com/jagankg/gatt) for documentation.
...
Please check [#32](https://github.com/jagankg/gatt/issues/32) for the status of this issue.
